...
import WebSeriesDetails from "./Web_series_Details";
import Slider from "../Home page/Home page components/Slider"; // Make sure this path is correct
...
export default Main_WebSeries_page;
